...
WEIGHTS_BASE_FOLDER="/gpfs/scratch/bsc28/bsc28459/3dgan_data/weights_fp32_200k_test/"
...
REAL_DATA_FILE="EleEscan_2_9.h5"
...
RESULTS_BASE_FOLDER="/gpfs/scratch/bsc28/bsc28459/3dgan_data/results_fp32_200k_test/"
...
RESULTS_FILE_TEST="EleEscan_2_9_fp32_200k_test_epoch_"
FILE_EXTENSION=".pdf"
...
do
    ...
    python ../eval_params_several_weights.py --weights_train $f --real_data $FULL_REAL_DATA_FILE \
